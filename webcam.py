...
# Classes
people = ['Ben Affleck', 'Cherishma Shankar', 'Elton John',
          'Jerry Seinfeld', 'Madonna', 'Mindy Kaling']
...
while True:
    ...
    for face in faces:
        ...
        # resize to (160,160)
        face_pixels_resized = cv2.resize(
            face_pixels, (160, 160), interpolation=cv2.INTER_AREA)
        ...
        cv2.putText(frame, predicted_name, (x, y),
